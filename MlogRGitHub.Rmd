...
2.  Logistic Regression in R by Mark Bounthavong <https://rpubs.com/mbounthavong/logistic_regression>

3.  Logistic Regression in R by MArk BOunthaving Part 2 <https://rpubs.com/mbounthavong/logistic_regression_part2>

4.  Goodness-of-fit test for a logistic regression model fitted using survey sample data by Kellie J. Archer and Stanley Lemeshow

5.  Detection of Ourliers and Influential Observations in Binary Logistic Regression: An empirical study by S.K Sarkar, Habshah Midi
