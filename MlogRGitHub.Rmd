...
We also tried to use `gof` function from `LogisticDx` package as suggested in Data Analysis in Medicine and Health using R by Kamarul Imran, Wan Nor Arifin, Tengku Muhammad Hanis Tengku Mokhtar. However, this caused error in diagnostic plots, hence we decided to not use `gof` function.
...
Currently, we have two model: Model A (prem.final.mod), and Adjusted Model (mlr.filtered.influential). Model A has the outcome of Ten Years Risk of CHD (TenYearCHD = chd/nochd) and the exposure is (diabetes) and other covariates based on Data2, Adjusted model has similiar outcome (Ten Year CHD) and predictor of interest(diabetes) and other covariates based on filtered data(outliers removed).
...
Gender, Age, Number of cigarette smoked per day, hypertension status and diabetes have significant association to .

1.  The log odds of developing 10 year risk of CHD in men is 0.50 (95% CI 0.29, 0.71, p \<0.001) compared to women, when adjusted to age, cigperday, hypertension status, diabetes and total cholesterol.
2.  Men has 1.64 time the odds compared to women developing 10 year risk of CHD (95% CI=1.34,2.02, p \<0.001) when adjusted to age, cigperday, hypertension status, diabetes and total cholesterol.
3.  With each 1 year old increase in age, the log odds for developing CHD in ten years changes by 0.07 (95% CI 0.06, 0.08, p \<0.001) when adjusted to gender, cigperday & hypertension status , diabetes and total cholesterol.
...
5.  With every 1 stick increase of cigarettes used per day, the log odds of having 10 year risk of CHD changes by 0.02 (95% CI 0.01, 0.03, p \<0.001) when adjusted to gender, age, hypertension status, diabetes and total cholesterol.
...
7.  The log odds of developing 10 year risk of CHD in participants with hypertension changes by 0.61 compared to those who does not have hypertension, (95% CI 0.40, 0.82, p \<0.001) when adjusted to gender, age, diabetes, tot cholesterol &cigperday.
...
9.  The log odds of developing 10 year risk of CHD in participants with diabetes changes by 0.72 compared to those who does not have hypertension, (95% CI 0.27, 1.16, p = 0.001) when adjusted to gender, age, total cholesterol, cigs per day and hypertension status.
...
1.  The log odds of developing 10 year risk of CHD in men is 0.86 compared to women (95% CI 0.56, 1.2, p \<0.001) when adjusted to age, cigperday, hypertension status.
...
3.  With 1 year old increase in age, the log odds for developing CHD in ten years is 0.13, (95% CI 0.11, 0.15,p \<0.001) when adjusted to gender, cigperday & hypertension status.
4.  Every 1 year increase of age, has 1.14 time the odds of developing CHD (95% CI: 1.11,1.16, p \<0.001) when adjusted to gender, cigperday & hypertension status.
5.  With every 1 stick increase of cigarettes used per day, the log odds of having 10 year risk of CHD is 0.02 (95% CI 0.01, 0.03, p \<0.001) when adjusted to gender, age, hypertension status.
6.  Every 1 stick of cigarette per day, has 1.02 time the odds of developing CHD (95% CI 1.01,1.03, p\<0.001) when adjusted to gender, age, hypertension status.
7.  The log odds of developing 10 year risk of CHD in participants with hypertension is 0.75 compared to those who does not have hypertension, (95% CI 0.47, 1.0, p \<0.001) when adjusted to gender, age, cigperday.
8.  Those who diagnosed with hypertension, has 2.12 time the odds of developing CHD (95% CI 1.60, 2.80, p \<0.001) when adjusted to gender, age, cigperday.
